...
//using a variety of functions to show how the string class could be used repeatedly to print the results to console without excessive repetition of code
...
void replace(String& string, const char* find, const char* replace);
...
void classAppendOutput(String& string1, String& string2)
{
	...
	std::cout << "The appended string is " << string1.Append(string2).Cstr() << std::endl;
...
void classPrependOutput(String& string1, String& string2)
{
	...
	std::cout << "The prepended string is " << string1.Prepend(string2).Cstr() << std::endl;
}
...
void toLowerOutput(String& string)
{
	...
	std::cout << "The member string " << string.Cstr() << " is " << string.ToLower().Cstr() << " in lower case" << std::endl;
}
...
void toUpperOutput(String& string)
{
	...
	std::cout << "The member string " << string.Cstr() << " is " << string.ToUpper().Cstr() << " in upper case" << std::endl;
}
...
void replace(String& string, const char* find, const char* replace)
{
	std::cout << "--- REPLACE FUNCTION (searching for l to replace with rr) ---" << std::endl;

	if (string.Replace(find, replace).Cstr() != "-1")
	{
		//std::cout << "The replaced string is now " << string.Replace(find, replace) << std::endl;

		std::cout << "The replaced string is now ";
		string.Replace(find, replace).WriteToConsole();
	}
	else
	{
